...
License  : Apache-2.0
Requires: mvn-scalactic_2.12-data = %{version}-%{release}

%description
No detailed description available

%package data
Summary: data components for the mvn-scalactic_2.12 package.
Group: Data

%description data
data components for the mvn-scalactic_2.12 package.
...
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/org/scalactic/scalactic_2.12/3.0.3/scalactic_2.12-3.0.3.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/scalactic/scalactic_2.12/3.0.0
cp %{SOURCE1} %{buildroot}/usr/share/java/.m2/repository/org/scalactic/scalactic_2.12/3.0.0/scalactic_2.12-3.0.0.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/scalactic/scalactic_2.12/3.0.0
cp %{SOURCE2} %{buildroot}/usr/share/java/.m2/repository/org/scalactic/scalactic_2.12/3.0.0/scalactic_2.12-3.0.0.pom
...
%files data
%defattr(-,root,root,-)
/usr/share/java/.m2/repository/org/scalactic/scalactic_2.12/3.0.0/scalactic_2.12-3.0.0.jar
